        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tbody>
                <?php $i = 1 ?>
                <?php foreach ($resep_barang as $resep) : ?>
                  <tr>
                    <td><?= $i ?></td>
                    <td><?= $resep['tanggal'] ?></td>
                        ...
                        <div class="modal-body">
                          ...
                          <div class="container">
                            <div class="row">
                              ...
                              <div class="col-sm-1 detail-th">Kode Barang</div>
                              <div class="col-sm-4 detail-th">Nama Barang</div>
                              <div class="col-sm-3 detail-th">Dosis Aturan Barang</div>
                            ...
                            <?php foreach ($detailBarang as $detail) : ?>
                              <?php if ($detail['id_transaksi'] == $resep['id_transaksi']) : ?>
                                <div class="row">
                                  ...
                                  <div class="col-sm-1 detail-cell"><?= $detail['kode_barang'] ?></div>
                                  <div class="col-sm-4 detail-cell"><?= $detail['nama_barang'] ?></div>
                                  <div class="col-sm-3 detail-cell"><?= $detail['dosis_aturan_barang'] ?></div>
