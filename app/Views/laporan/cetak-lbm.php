    ...
    ?>
        ...
        <div class="table-responsive">
            ...
            <table width="100%" border="1" style="border-collapse:collapse; border-spacing:0">
                ...
                <tbody>
                    <?php
                    $brg = $db->query("SELECT SUM(tbl_pembelian_detail.stok_pemesanan) stok_pemesanan, SUM(tbl_pembelian_detail.stok_masuk) stok_masuk, tbl_pembelian_detail.stok_masuk, tbl_barang.nama_barang, tbl_barang.nilai_satuan, tbl_barang.satuan AS satuan_pemesanan, tbl_satuan_barang.satuan_barang_name, tbl_pembelian.total, tbl_pembelian.faktur, tbl_pembelian.tanggal
                                                        FROM tbl_pembelian_detail
